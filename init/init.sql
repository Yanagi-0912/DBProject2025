...
INSERT INTO games (game_title, description, platform, genre, price, image) VALUES
    ...
    ('植物大戰殭屍','《植物大戰殭屍》是一款結合策略與塔防元素的遊戲，玩家需要利用各種植物來抵禦殭屍的入侵。','PC / Mobile','Strategy / Tower Defense',100,'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTPDmwF-4yjYrvsMVn5t2lTXemDfCbERNr_tA&s'),
    ('Arcaea','《Arcaea》是一款音樂節奏遊戲，玩家需要跟隨音樂的節奏點擊螢幕上的音符。','Mobile','Rhythm',0,'https://play-lh.googleusercontent.com/6vtKnbt-Rd5y5KIDHUy5adgZAmHBKBMmat0MiRh53qPYr6KqIvgSsYcqAQCsP_CeXXM'),
